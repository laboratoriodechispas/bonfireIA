<?php
class Migration_inscripciones_table extends Migration
{
    /*
    ...
    public function up()
    {
        ...
        $this->dbforge->create_table('tbl_inscripciones');

// Create the Permissions
        $this->load->model('permission_model');
        $this->permission_model->insert(array(
            'name'          => 'Bonfire.tbl_inscripciones.View',
...
// Assign them to the admin role
        ...
        $this->role_permission_model->assign_to_role('Administrator', 'Bonfire.tbl_inscripciones.View');
    }
...
//--------------------------------------------------------------------
    ...
    public function down()
    {
        ...
        $this->dbforge->drop_table('tbl_inscripciones');
    }
