<?php
class Migration_requerimientos_table extends Migration
{
    /*
    ...
    public function up()
    {
        ...
        $this->dbforge->add_field('edad_min int(10) NOT NULL');
        $this->dbforge->add_field('edad_max int(10) NOT NULL');
        ...
        $this->dbforge->create_table('tbl_requerimientos');

// Create the Permissions
        $this->load->model('permission_model');
        $this->permission_model->insert(array(
            'name'          => 'Bonfire.tbl_requerimientos.View',
...
// Assign them to the admin role
        ...
        $this->role_permission_model->assign_to_role('Administrator', 'Bonfire.tbl_requerimientos.View');
    }
...
//--------------------------------------------------------------------
    ...
    public function down()
    {
        ...
        $this->dbforge->drop_table('tbl_requerimientos');
    }
